...
Much of post-colonial literature reflects an assimilationist model of national identity. In the first decades after decolonization, leaders of many African states have focused on promoting a unified national identity to strengthen the newly-formed state. This commonly involved assimilation of various ethnic groups because ethnic diversity was thought to be a source of conflict. In Botswana, for example, the goal of assimilationist policies was to construe a national identity based on the culture of the Tswana. Hence, members of minorities often faced a tradeoff where they had to sacrifice some of their ethnic identity to gain goods associated with national identification. For example, native languages and family traditions had to give way for majority culture which promised better career chances [@mulimbi2019experiences]. Only more recently has there been a theoretical shift from the assimilationist model to a multicultural model which recognizes the potential for national identification to develop in parallel to existing ethnic identification. Within the multicultural framework, cultural diversity is understood to be part of the national identity, and ethnick diversity is acknowledged as to facilitate co-existence and cooperation of the different groups[@priwati2021multiculturalism].

(see Tanzania).  

Much of the research on the multicultural mode has been conducted in migrant communities. These studies consistently find that ethnic and national identification are compatible. For instance, @ryder2000 report that ethnic identification and national identification are independent and have distinctive correlations with external variables during the process of acculturation among immigrants in the US. In particular, some immigrants appear to incorporate their heritage and mainstream cultural identities. A more recent study, surveying adolescent immigrants from 13 countries, confirms these findings. The relationship between ethnic and national identification varies widely both across countries and across individuals, ranging from negative to no relationship to positive [@berry2006].

So far, there seems to be little evidence on the social identities of non-migrant communities in multi-ethnic countries. However, @davis1999 reports two different forms of identification among the Basque people. One entails attachment to a Basque nation, the other is 'apolitical' in that it dissociates the nationalist movement from the perception of being Basque. It seems like dual identification may be possible among individuals who hold such an apolitical form of ethnic identification. Further, evidence from secondary schools in Botswana suggests that both majority and minority ethnic students perceive their ethnic and national identities to be compatible [@mulimbi2019experiences].
...
In a second model, I will control for the z-score of the number of social ties a student has (see appendix for question wording):
