...
Studies conducted in migrant communities consistently find that ethnic and national identification are compatible. For instance, @ryder2000 report that ethnic identification and national identification are independent and have distinctive correlations with external variables during the process of acculturation among immigrants in the US. A more recent study, surveying adolescent immigrants from 13 countries, confirms these findings. The relationship between ethnic and national identification varies widely both across countries and across individuals, ranging from negative to no relationship to positive [@berry2006].
...
In order to evaluate the assumption that ethnic and national identification are incompatible, I use data from a representative survey of 825 students of Addis Ababa University (AAU). The survey consists of two waves, conducted in May-June and October-November of 2022. The data was collected by DevLab researchers from the University of Pennsylvania [@DevLabAAU].
...
$NationalID$ is the averaged z-score of two measures of national identification (see the Appendix for question wording), $EthnicID$ the averaged z-score of two measures of ethnic identification, and $\epsilon$ the error term.

In a second model, I will control for the number of social ties a student has.

$$ NationalID_i = \alpha + \beta_1 * EthnicID_i + \beta_2 * SocialTies_i +  \epsilon_i $$

$SocialTies$ is the z-score of the number of social ties. Social ties could be a confounding variable because students who interact more frequently with others might feel more connected to both their ethnic group and their nationality. Hence, the relationship between ethnic and national identification would be more negative when controlling for the number of social ties.
...
The distributions of ethnic and national identification, as well as the number of social ties, are negatively skewed. This implies that there are few students with relatively strong national identification, few with relatively strong ethnic identification, and few with a large number of social ties. The mean number of social ties is thereby 15. Almost half of the students say that their ethnic group is 'frequently' discriminated against, followed by about a third who say that their group is 'never' discriminated against. Eighteen percent say their group is 'always' discriminated against.
