...
Much of post-colonial literature reflects an assimilationist model of national identity. In the first decades after decolonization, leaders of many African states focused on promoting a unified national identity to strengthen the newly-formed nation-states. This commonly involved assimilating various ethnic groups, as ethnic diversity was perceived as a source of conflict. For instance, in Botswana, assimilationist policies aimed to construct a national identity based Tswana culture. Similarily, in Tanzania, the Tanganyika African National Union (TANU) under Julius Nyerere attempted to build a national identity around Swahili culture and language. Consequently, members of minority groups often faced a tradeoff, sacrificing aspects of their ethnic identity for benefits associated with national identification, such as better career opportunities [@mulimbi2019experiences; @campbell1999nationalism]. Only recently has there been a theoretical shift from the assimilationist model to a multicultural one, recognizing the potential for national identification to coexist alongside ethnic identification. Within the multicultural framework, cultural diversity is seen as integral to national identity, and ethnick diversity is acknowledged as facilitating the coexistence and cooperation of different groups[@priwati2021multiculturalism].

Much of the research on the multicultural model has been conducted in migrant communities, consistently finding that ethnic and national identification are compatible. For instance, @ryder2000 report that ethnic identification and national identification are independent and have distinctive correlations with external variables during the process of acculturation among immigrants in the US. In particular, some immigrants appear to incorporate their heritage and mainstream cultural identities. A more recent study surveying adolescent immigrants from 13 countries confirms these findings, showing a varied relationship between ethnic and national identification across countries and individuals, ranging from negative to positive [@berry2006].
