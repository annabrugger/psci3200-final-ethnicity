...
The bottom-left graph shows that nearly half of the students report frequent discrimination against their ethnic group, with approximately one third stating their group experiences no discrimination at all. Eighteen percent say their group faces constant discrimination. The bottom-right graph shows that the belief in multiculturalism is overall weak among the surveyed students. 43% of them strongly believe that homogeneous communities are stronger than diverse ones, and only 4% strongly believe that the opposite is true.
...
At AAU, students' belief in multiculturalism is negatively correlated with, i.e., it prevents rather than fosters national identification. This negative relationship makes sense in the context of the government's conflict with the Tigray in the North of the country which makes it difficult to associate Ethiopian national identity with multiculturalism. In the future, however, the integration of multiculturalism into the national identity may prove to be an effective strategy to foster dual identification.
