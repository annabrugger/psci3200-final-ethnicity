...
There seems to be little evidence on the social identities of non-migrant communities in multi-ethnic countries. ... Interesting ...
...
m1 <- lm(national_index ~ ethnic_index, data = dat_z)
...
m2 <- lm(national_index ~ ethnic_index + urban + contacts, data = dat_z)
...
m2 <- lm(national_index ~ ethnic_index * discrimination, data = dat_z)
summary(m2)
```
...
mean(dat_z$urban[dat_z$dual_id == 1], na.rm = TRUE) 
